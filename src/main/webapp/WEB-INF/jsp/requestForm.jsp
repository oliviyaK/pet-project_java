...
<form class="form-inner">
    ...
    <form class="form-inner">
        ...
        <form class="form-inner">
            <div class="stripes-block"></div>
            <div class="form-row-refr"><fmt:message key="button.enter.date"/><label><form:input type="date" path="date"/></label></div>
            <div class="form-row-refr"><fmt:message key="button.enter.typeOfRequest"/><label><form:input path="requestType"/></label></div>
            <div class="form-row-refr"><fmt:message key="button.enter.finalDate"/><label><form:input type="date" path="finalDate"/></label></div>
            <div class="form-row-refr"><fmt:message key="button.enter.finalComment"/><label><form:input path="comment"/></label></div>
            <div class="form-row-refr"><fmt:message key="button.enter.price"/><label><form:input path="price"/></label></div>
            <div class="form-row-refr">
