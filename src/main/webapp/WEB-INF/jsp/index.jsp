...
<div style="text-align: right;">
    <a class="small_floating-button" href="${pageContext.request.contextPath}/index?locale=en_US"><fmt:message key="lang.en"/></a>
    <a class="small_floating-button" href="${pageContext.request.contextPath}/index?locale=ru_RU"><fmt:message key="lang.ru"/></a>
</div>
<head>
    <title><fmt:message key="button.main.page"/></title>
</head>
<body>
<div style="text-align: center;"><div class="d13">
    <h1><fmt:message key="title.page.welcome" /></h1> </div>
