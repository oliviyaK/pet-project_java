...
<div style="text-align: right;">
    <a class="small_floating-button" href="${pageContext.request.contextPath}/refrigerator?locale=en_US"><fmt:message
            key="lang.en"/></a>
    <a class="small_floating-button" href="${pageContext.request.contextPath}/refrigerator?locale=ru_RU"><fmt:message
            key="lang.ru"/></a>
</div>
        ...
        <table>
            ...
            <c:forEach var="refrigerator" items="${refrigerators}">
                <tr>
                    ...
                    <td>
                        <a class="smallButton"
                           href="${pageContext.request.contextPath}/refrigerator/edit?id=${refrigerator.id}"><fmt:message
                                key="button.update"/></a>
                        <sec:authorize access="hasAuthority('ADMIN')">
                            <a class="smallButton"
                               href="${pageContext.request.contextPath}/refrigerator/delete?id=${refrigerator.id}"><fmt:message
